...
def draw_text_with_outline(
    draw, position, text, font, fill, outline_color=(0, 0, 0), outline_width=4
):
...
draw_text_with_outline(
    draw, (width / 2 - 180, 480), hyper_text, font_medium, (0, 255, 255)
)
...
draw_text_with_outline(
    draw, (width / 2 + 180, 480), nexus_text, font_medium, (255, 0, 255)
)
