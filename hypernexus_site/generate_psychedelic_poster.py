...
# Draw shadow
draw.text(
    (width / 2 + 3, 223), title, font=font_large, fill=(0, 0, 0, 200), anchor="mm"
)
# Draw main text
draw.text(
    (width / 2, 220), title, font=font_large, fill=(255, 255, 255, 255), anchor="mm"
)

# Subtitle
subtitle = "HYPERNEXUS"
draw.text(
    (width / 2 + 2, 332), subtitle, font=font_medium, fill=(0, 0, 0, 200), anchor="mm"
)
draw.text(
    (width / 2, 330), subtitle, font=font_medium, fill=(0, 255, 255, 255), anchor="mm"
)

# Features
features = "Local-First • Persistent Memory • Zero Downtime"
draw.text(
    (width / 2 + 2, 412), features, font=font_small, fill=(0, 0, 0, 200), anchor="mm"
)
draw.text(
    (width / 2, 410), features, font=font_small, fill=(255, 255, 0, 255), anchor="mm"
)
