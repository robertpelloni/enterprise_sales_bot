...
img.save(
    "C:/Users/hyper/workspace/marketing_agent/hypernexus_site/hypernexus_poster_optimized.jpg",
    "JPEG",
    quality=75,
    optimize=True,
)
...
print(
    f"Optimized: {os.path.getsize('C:/Users/hyper/workspace/marketing_agent/hypernexus_site/hypernexus_poster_optimized.jpg')} bytes"
)
...
img = img.resize((1200, 630), Image.Resampling.LANCZOS)
img.save(
    "C:/Users/hyper/workspace/marketing_agent/tormentnexus_site/og-image-optimized.png",
    "PNG",
    optimize=True,
)
print(
...
print(
    f"Optimized: {os.path.getsize('C:/Users/hyper/workspace/marketing_agent/tormentnexus_site/og-image-optimized.png')} bytes"
)
