...
img.save('C:/Users/hyper/workspace/marketing_agent/tormentnexus_site/og-image-optimized.jpg', 'JPEG', quality=75, optimize=True)
print(f"Original: {os.path.getsize('C:/Users/hyper/workspace/marketing_agent/tormentnexus_site/hypernexus_poster.jpg')} bytes")
print(f"Optimized: {os.path.getsize('C:/Users/hyper/workspace/marketing_agent/tormentnexus_site/og-image-optimized.jpg')} bytes")
