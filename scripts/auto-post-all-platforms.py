        ...
        response = requests.post(
            ...
            json={
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": "You are an expert technical writer. Write concise, authentic content for developer audiences. No fluff, no marketing speak.",
                    },
...
def post_to_twitter(browser_ws):
    ...
    ws.send(
        json.dumps(
            {"id": 3, "method": "Input.insertText", "params": {"text": tweet[:280]}}
        )
    )
    time.sleep(2)
