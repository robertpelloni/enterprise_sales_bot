...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://sales_bot:tormentnexus2026@localhost:5432/sales_bot")
APOLLO_API_KEY = os.environ.get("APOLLO_API_KEY", "Hk2hKzzYIddTsygrnoufDw")
HUNTER_API_KEY = os.environ.get("HUNTER_API_KEY", "6d2e42cff14189b3c2453e8e4155efa27e1f02b2")
...
TARGET_ROLES = [
    "purchasing", "procurement", "vendor", "sourcing", "buyer",
    "purchasing agent", "purchasing manager", "procurement manager",
    "software buyer", "it procurement", "technology procurement",
    "vendor management", "supplier", "acquisition",
    "vp procurement", "director procurement", "head of procurement",
    "chief procurement", "cpo", "procurement analyst",
    "software asset", "it asset", "license management",
    "it sourcing", "cloud procurement", "saas procurement"
]

# Target company types
TARGET_INDUSTRIES = [
    "technology", "software", "saas", "ai", "machine learning",
    "fintech", "healthtech", "edtech", "cybersecurity", "cloud",
    "data", "analytics", "enterprise", "consulting", "financial services",
    "banking", "insurance", "healthcare", "pharmaceutical", "biotech"
]
...
def find_tech_companies_google():
    ...
    tech_domains = [
        ...
        "datadog.com", "snowflake.com", "databricks.com", "confluent.io",
        "twilio.com", "sendgrid.com", "stripe.com", "squareup.com",
        "atlassian.com", "github.com", "gitlab.com", "bitbucket.org",
        "docker.com", "kubernetes.io", "terraform.io", "hashicorp.com",
        "newrelic.com", "dynatrace.com", "splunk.com", "elastic.co",
        "cloudflare.com", "fastly.com", "akamai.com", "imperva.com",
        "paloaltonetworks.com", "crowdstrike.com", "sentinelone.com",
        "zscaler.com", "netskope.com", "illumio.com",
        "notion.so", "airtable.com", "monday.com", "asana.com",
        "figma.com", "canva.com", "miro.com", "loom.com",
        "intercom.com", "zendesk.com", "freshworks.com", "servicenow.com",
        "workday.com", "successfactors.com", "bamboohr.com", "gusto.com",
        "brex.com", "ramp.com", "bill.com", "coupa.com",
        "salesforce.com", "oracle.com", "sap.com", "microsoft.com",
        "google.com", "amazon.com", "apple.com", "meta.com",
        "ibm.com", "cisco.com", "vmware.com", "dell.com",
        "hp.com", "lenovo.com", "nvidia.com", "amd.com",
        "intel.com", "qualcomm.com", "broadcom.com", "marvell.com"
    ]
...
def send_email(to_email, subject, body, from_email="pelloni.robert@gmail.com", from_name="HyperNexus Team"):
    """Send email via SMTP"""
    import smtplib
...
def run_email_campaign(limit=20):
    ...
    for contact in contacts:
        ...
        # Determine brand based on role
        if any(kw in role_lower for kw in ["cto", "vp", "director", "head", "chief", "ciso", "cpo"]):
            brand = "hypernexus"
        elif any(kw in role_lower for kw in ["developer", "engineer", "architect", "technologist"]):
            brand = "tormentnexus"
        else:
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Purchasing Agent Scraper & Email Campaign")
    parser.add_argument("--scrape", action="store_true", help="Run scraper to find purchasing contacts")
    parser.add_argument("--campaign", action="store_true", help="Run email campaign")
    parser.add_argument("--stats", action="store_true", help="Show database statistics")
    parser.add_argument("--limit", type=int, default=20, help="Limit contacts per campaign run")
    parser.add_argument("--all", action="store_true", help="Run both scraper and campaign")
