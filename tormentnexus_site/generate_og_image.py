...
# Draw text
draw.text(
    (width / 2, 180), "AT LONG LAST", font=font_medium, fill="#00ff88", anchor="mm"
)
draw.text(
    (width / 2, 300),
    "THE MACHINES AWAKEN",
...
draw.text(
    (width / 2, 420), "TormentNexus", font=font_small, fill="#ffffff", anchor="mm"
)
draw.text(
    (width / 2, 480),
...
draw.text(
    (width / 2, 550), "tormentnexus.site", font=font_tiny, fill="#666666", anchor="mm"
)
